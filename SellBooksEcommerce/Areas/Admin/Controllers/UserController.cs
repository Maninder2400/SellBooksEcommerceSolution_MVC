...
namespace SellBooksEcommerce.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagment(string userId)
        {
            ...
            {
                ApplicationUser = _unitOfWork.ApplicationUser.Get(u => u.Id == userId, includeNavProperties: "Company"),
                //projections
        ...
        {
            List<ApplicationUser> objUserList = _unitOfWork.ApplicationUser.GetAll(includeNavProperties: "Company").ToList();
